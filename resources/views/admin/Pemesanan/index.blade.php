@extends('layouts.app', ['title' => 'Pemesanan - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.Pemesanan.create') }}">TAMBAH</a>
            </button>
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            <div class="inline-block min-w-full shadow-sm rounded-lg overflow-hidden">
                <table class="min-w-full table-auto">
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            <th class="px-16 py-2">
                                <span class="text-white">TANGGAL PEMESANAN</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">TANGGAL PERNIKAHAN</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">TOTAL BIAYA</span>
                            </th>
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">STATUS PEMESANAN</span>
                            </th>
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <!--Action untuk tombol hapus dan edit -->
                            ...
                            <td class="px-10 py-2 text-center">
                                ...
                                <button onClick="destroy(this.id)" id="{{ $Pemesanan->id }}"
                                    class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                            </td>
                        </tr>
                        @empty
                             <div class="bg-red-500 text-center p-3 rounded-sm shadow-md">
                                    Data Belum Tersedia!
                            </div>
                            </td>
                        </tr>
                ...
                <div class="bg-white p-3">
                    {{ $Pemesanan->links('vendor.pagination.tailwind') }}
                </div>
                @endif
            </div>
        </div>
