@extends('layouts.app', ['title' => 'Supplier - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.supplier.create') }}">TAMBAH</a>
            </button>
                    ...
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            ...
                            <th class="px-16 py-2 text-left">
                                <span class="text-white">NO. KONTAK</span>
                            </th>
                            <th class="px-16 py-2 text-left">
