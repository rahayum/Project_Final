        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        <label class="text-gray-700" for="nama_kategori">NAMA KATEGORI</label>
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="nama_kategori" value="{{ old('nama_kategori', $category->nama_kategori) }}" placeholder="Nama Kategori">
                        @error('nama_kategori')
